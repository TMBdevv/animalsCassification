...
st.markdown('Salom bu :blue[HK modeli] :sunglasses: Model siz joylagan rasmlaringizni klassifikatsiya qilish uchun mo‘ljallangan bo‘lib quyidagi 13 ta hayvoni taniy oladi :sparkles: :underline[Tuya, Jiraf, Karkidon, Echki, Ot, Kenguru, Koala, Quyon, Qo‘y, Zebra, Maymun, Kiyik, Fil]:blue ')
...
if file or (filec_option and filec):
    ...
    if probs[pred_id]*100 > 70:
        ...
        st.error(f"🚨 Rasmdagi jonivorni tasniflay olmadim. Bu noyob tur yoki hozirgi mashg'ulot ma'lumotlarimdan tashqari biror narsa bo'lishi mumkin")
        ...
        if st.button("Send"):
            ...
            st.info(f"Xatolikni aytganingiz uchun rahmat.")
            if error_message:
                st.write("")
